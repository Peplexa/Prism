...
// Detail charts live inside a collapsible section that starts display:none.
// Initializing Chart.js while the parent is hidden bakes a default-size
// canvas that gets CSS-stretched (and blurred) when the section is later
// expanded. Lazy-init on first reveal so the canvas backing buffer matches
// the actual rendered size at devicePixelRatio.
