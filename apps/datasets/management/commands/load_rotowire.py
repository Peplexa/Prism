"""
Management command to load Rotowire dataset.
"""
...
class Command(BaseCommand):
    help = "Load Rotowire dataset into database"
    ...
    def add_arguments(self, parser):
        ...
        parser.add_argument(
            "--extract-facts",
            action="store_true",
            help="Extract ground truth facts from box scores",
        )
        parser.add_argument(
            "--clear",
            action="store_true",
    ...
    def handle(self, *args, **options):
        ...
        source, created = DataSource.objects.get_or_create(
            ...
            defaults={
                ...
                "loader_class": "apps.datasets.loaders.RotowireLoader",
            },
        )
        ...
        # Load documents
        self.stdout.write(f"Loading Rotowire {split} split...")
        ...
        try:
            documents = list(loader.load(split=split, limit=limit))
